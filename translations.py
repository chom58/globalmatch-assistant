...
TRANSLATIONS = {
    "ja": {
        ...
        "feature.resume_rirekisho": "履歴書作成（JIS形式）",
        "feature.jd_jp_en": "求人票魅力化（日→英）",

        # ===== 履歴書作成（JIS形式） =====
        "rirekisho_title": "履歴書作成（英語CV → 日本語 JIS 形式）",
        "rirekisho_desc": "英語CVから AI が下書きを作成し、不足項目だけ入力すれば企業提出用の履歴書（Excel / PDF）が完成します",
        "rirekisho_step1": "##### ① 英語CVを入力して下書きを作成",
        "rirekisho_step2": "##### ② 内容を確認・不足項目を入力",
        "rirekisho_step3": "##### ③ 履歴書を生成",
        "rirekisho_draft_btn": "🤖 AIで下書きを作成",
        "rirekisho_drafting": "🤖 AIがCVから履歴書の項目を抽出しています...",
        "rirekisho_draft_done": "✅ 下書き作成完了（{time}秒）。下のフォームで内容を確認してください",
        "rirekisho_placeholder": "上で英語CVを入力し「AIで下書きを作成」を押すと、ここに入力フォームが表示されます",
        "rirekisho_missing": "⚠️ CVに記載がなく候補者への確認が必要な項目: {fields}",
        "rirekisho_f_name": "氏名（CV表記）",
        "rirekisho_f_name_kana": "ふりがな（カタカナ）",
        "rirekisho_f_birth_date": "生年月日（YYYY-MM-DD）",
        "rirekisho_f_gender": "性別（任意・空欄可）",
        "rirekisho_f_postal_code": "郵便番号",
        "rirekisho_f_address": "現住所",
        "rirekisho_f_address_kana": "現住所ふりがな",
        "rirekisho_f_phone": "電話番号",
        "rirekisho_f_email": "E-mail",
        "rirekisho_f_date": "記入日",
        "rirekisho_f_motivation": "志望の動機・アピールポイント",
        "rirekisho_f_wishes": "本人希望記入欄",
        "rirekisho_f_education_dates": "学歴の入学・卒業年月",
        "rirekisho_form_edu": "**学歴**（古い順・「入学」「卒業」で1行ずつ）",
        "rirekisho_form_work": "**職歴**（古い順・「入社」「退職」で1行ずつ。在職中は最後に「現在に至る」）",
        "rirekisho_form_qual": "**資格・免許**",
        "rirekisho_col_year": "年（西暦）",
        "rirekisho_col_month": "月",
        "rirekisho_col_text": "内容",
        "rirekisho_photo": "証明写真（任意・JPG/PNG。3:4 に自動トリミング）",
        "rirekisho_generate_btn": "📄 履歴書を生成",
        "rirekisho_generated": "✅ 履歴書を生成しました",
        "rirekisho_overflow": "⚠️ 学歴・職歴が {max} 行を超えたため、末尾 {n} 行を省略しました。行を減らして再生成してください",
        "rirekisho_qual_overflow": "⚠️ 資格・免許が {max} 行を超えたため、{n} 件を省略しました",
        "rirekisho_dl_xlsx": "📥 Excel をダウンロード",
        "rirekisho_dl_pdf": "📥 PDF をダウンロード",
        "rirekisho_pdf_unavailable": "PDF 変換はこの環境では利用できません（LibreOffice 未導入）。Excel を開いて PDF 保存してください",
        "rirekisho_invalid_date": "⚠️ 生年月日の形式が不正です（例: 1990-05-14）。空欄のまま出力します",
        ...
        "cv_title": "CV提案コメント抽出",
        "cv_desc": "CVから5セクションの提案コメント（Headline / Career / Strengths / Education / Assessment）を抽出します。日英切替・スライド貼付最適化・一括処理対応。",
        "cv_mode_label": "入力モード",
        ...
        "cv_done": "✅ 抽出完了！（{time}秒）",
        "cv_length_slider": "各セクション合計の目安文字数（商談資料は300前後）",
    ...
    "en": {
        ...
        "feature.resume_rirekisho": "Rirekisho Builder (JIS format)",
        "feature.jd_jp_en": "JD Enhancement (JP→EN)",

        # ===== Rirekisho Builder (JIS format) =====
        "rirekisho_title": "Rirekisho Builder (English CV → Japanese JIS format)",
        "rirekisho_desc": "AI drafts a Japanese 履歴書 from the English CV; fill in only the missing fields and download Excel / PDF for company submission",
        "rirekisho_step1": "##### ① Input the English CV and create a draft",
        "rirekisho_step2": "##### ② Review and fill in missing fields",
        "rirekisho_step3": "##### ③ Generate the rirekisho",
        "rirekisho_draft_btn": "🤖 Create draft with AI",
        "rirekisho_drafting": "🤖 AI is extracting rirekisho fields from the CV...",
        "rirekisho_draft_done": "✅ Draft ready ({time}s). Review the form below",
        "rirekisho_placeholder": "Enter the English CV above and click 'Create draft with AI' to open the form here",
        "rirekisho_missing": "⚠️ Not found in the CV — confirm with the candidate: {fields}",
        "rirekisho_f_name": "Name (as in CV)",
        "rirekisho_f_name_kana": "Furigana (katakana)",
        "rirekisho_f_birth_date": "Date of birth (YYYY-MM-DD)",
        "rirekisho_f_gender": "Gender (optional)",
        "rirekisho_f_postal_code": "Postal code",
        "rirekisho_f_address": "Current address",
        "rirekisho_f_address_kana": "Address furigana",
        "rirekisho_f_phone": "Phone",
        "rirekisho_f_email": "E-mail",
        "rirekisho_f_date": "Date of writing",
        "rirekisho_f_motivation": "Motivation / self-PR",
        "rirekisho_f_wishes": "Personal requests (本人希望記入欄)",
        "rirekisho_f_education_dates": "Education start/end dates",
        "rirekisho_form_edu": "**Education** (oldest first; one row each for 入学 / 卒業)",
        "rirekisho_form_work": "**Work history** (oldest first; one row each for 入社 / 退職; end with 現在に至る if employed)",
        "rirekisho_form_qual": "**Qualifications / licenses**",
        "rirekisho_col_year": "Year",
        "rirekisho_col_month": "Month",
        "rirekisho_col_text": "Description",
        "rirekisho_photo": "ID photo (optional, JPG/PNG; auto-cropped to 3:4)",
        "rirekisho_generate_btn": "📄 Generate rirekisho",
        "rirekisho_generated": "✅ Rirekisho generated",
        "rirekisho_overflow": "⚠️ Education/work history exceeded {max} rows; the last {n} rows were dropped. Reduce rows and regenerate",
        "rirekisho_qual_overflow": "⚠️ Qualifications exceeded {max} rows; {n} items were dropped",
        "rirekisho_dl_xlsx": "📥 Download Excel",
        "rirekisho_dl_pdf": "📥 Download PDF",
        "rirekisho_pdf_unavailable": "PDF conversion is unavailable here (LibreOffice not installed). Open the Excel file and save as PDF",
        "rirekisho_invalid_date": "⚠️ Invalid date of birth format (e.g. 1990-05-14). It will be left blank",
        ...
        "cv_desc": "Extract a 5-section candidate pitch (Headline / Career / Strengths / Education / Assessment) from CVs. JP/EN toggle, slide-ready, batch-capable.",
        ...
        "cv_length_slider": "Target chars per section total (≈300 for sales decks)",
        "cv_adjust_btn": "Adjust Length",
        "cv_adjusting": "Adjusting...",
        "cv_adjusted": "✅ Adjustment complete!",
        "cv_lang_label": "🌐 Output Language",
        "cv_lang_ja": "Japanese",
        "cv_lang_en": "English",
