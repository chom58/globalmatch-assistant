...
TRANSLATIONS = {
    "ja": {
        ...
        "gemini_fallback_help": "設定するとGroqがレート制限に達したとき自動でGemini 2.0 Flashに切り替わります。[Google AI Studio](https://aistudio.google.com/app/apikey) で無料取得可能",
    ...
    "en": {
        ...
        "gemini_fallback_placeholder": "Gemini API Key",
        "gemini_fallback_help": "When set, automatically fails over to Gemini 2.0 Flash if Groq hits rate limits. Get a free key at [Google AI Studio](https://aistudio.google.com/app/apikey)",
