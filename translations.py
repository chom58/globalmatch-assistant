...
TRANSLATIONS = {
    "ja": {
        ...
        "delete_item": "🗑️ この項目を削除",
        "delete_all_history": "🗑️ 全履歴を削除",
        ...
        "email_delete_set": "🗑️ すべてのセットを削除",
        "email_delete_jobs": "🗑️ すべての個別求人を削除",
        "email_no_sets_mgmt": "保存済みセットはありません",
        "email_no_jobs_mgmt": "保存済みの個別求人はありません",

        # ----- Email: Batch Mode -----
        "email_tab_manual": "✏️ 手動入力モード",
    ...
    "en": {
        ...
        # ===== Feature 3: Resume PII Removal =====
        "pii_title": "🛡️ Resume PII Removal",
        ...
        "pii_placeholder": "Paste the resume here...",
        "pii_info": "🛡️ Removed: email, LinkedIn, phone, address\n\n📝 Name is changed to first name only",
        "pii_btn": "🛡️ Remove PII",
        ...
        "delete_item": "🗑️ Delete this item",
        "delete_all_history": "🗑️ Delete all history",
        ...
        # ===== Feature 11: Email =====
        "email_title": "✉️ Job Offer Email Generator",
        ...
        "email_delete_set": "🗑️ Delete All Sets",
        "email_delete_jobs": "🗑️ Delete All Jobs",
        "email_no_sets_mgmt": "No saved sets",
        "email_no_jobs_mgmt": "No saved jobs",

        # ----- Email: Batch Mode -----
        "email_tab_manual": "✏️ Manual Input Mode",
        ...
        "email_batch_clear": "🗑️ Clear Extraction Results",
